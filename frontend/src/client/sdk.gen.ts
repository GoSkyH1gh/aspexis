 ...
 * Get Capes
 */
export const getCapesV1PlayersCapesUuidGet = <ThrowOnError extends boolean = false>(options: Options<GetCapesV1PlayersCapesUuidGetData, ThrowOnError>) => {
    return (options.client ?? client).get<GetCapesV1PlayersCapesUuidGetResponses, GetCapesV1PlayersCapesUuidGetErrors, ThrowOnError>({
 ...
 * Get Player Status
 */
export const getPlayerStatusV1PlayersStatusUuidGet = <ThrowOnError extends boolean = false>(options: Options<GetPlayerStatusV1PlayersStatusUuidGetData, ThrowOnError>) => {
    return (options.client ?? client).get<GetPlayerStatusV1PlayersStatusUuidGetResponses, GetPlayerStatusV1PlayersStatusUuidGetErrors, ThrowOnError>({
